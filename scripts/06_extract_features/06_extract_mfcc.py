...
def process_mfcc():
    ...
    for label_idx, class_name in enumerate(CLASSES):
        ...
        print(f"Processing: {class_name} (MFCC)")
        ...
        for idx, f in enumerate(files):
            ...
            try:
                ...
                data.append(z_score_normalize(extract_mfcc(segment)))
                ...
                if class_name != "noise":
                    ...
                    data.append(z_score_normalize(extract_mfcc(aug_y)))
                    labels.append(label_idx)
            except Exception:
                continue
    ...
    print(f"\nDone. Saved MFCC {X.shape} -> {OUTPUT_PATH}")

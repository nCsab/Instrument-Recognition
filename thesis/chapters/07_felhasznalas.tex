...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{fig_realtime_setup.png}
...
\begin{enumerate}
    \item \textbf{Dinamikus konfidencia-sáv:} Egy 20 karakter hosszúságú grafikus sáv, amely a felismert hangszer valószínűségét ábrázolja vizuálisan. A teli blokk (\texttt{█}) karakterek a konfidencia nagyságát mutatják, míg a satírozott (\texttt{░}) karakterek a fennmaradó részt.
    \item \textbf{Aktív osztály és konfidencia érték:} A felismert hangszer megnevezése és a kiszámított valószínűségi százalékos érték (tizedes pontossággal).
...
A konfúziós mátrix elemzésénél láttuk, hogy a nádfúvósok és rézfúvósok között a legmagasabb a tévesztési arány. Amikor a felhasználó szaxofonon játszik, a modell kezdetben a rézfúvós és nádfúvós osztályok között oszcillálhat. A hiszterézis bónusz ($+5\%$) és a konfidencia-küszöb ($30\%$) megakadályozza a kijelző gyors villogását: a kijelző narancssárga \texttt{reed} színben marad mindaddig, amíg a rézfúvós alternatíva át nem lépi a biztonsági küszöböt (lásd a \ref{fig:realtime_reed}.~ábrát):
...
A felhasználó bármikor megszakíthatja az élő elemzést a terminálban kiadott \texttt{Ctrl+C} billentyűkombinációval. Ekkor a parancssori visszahívási szálak lezárulnak, a mikrofonbemenet felszabadul, és a program tiszta állapotban kilép a terminálba:

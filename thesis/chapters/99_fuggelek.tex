...
A benyújtott digitális függelék (amely a GitHubon elérhető nyilvános Git
adattárban\footnote{\url{https://github.com/nCsab/Instrument-Recognition}} is
megtalálható) az alábbi főbb könyvtárakat tartalmazza. A számozott szkriptek a
feldolgozási csővezeték egymásra épülő lépéseit jelzik.
...
\texttt{scripts/archive/05b\_\allowbreak realtime\_\allowbreak yamnet.py} & Archivált YAMNet realtime kísérleti script; nem a dolgozat fő, valós idejű alkalmazása. \\
